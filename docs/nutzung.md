...
* **💬 Automatische WhatsApp-Nachrichten (WhatsApp-Zeile ganz unten in der Matrix):**  
  ...
  * **Ankunftszeit & Spielort:** Am Ende der Nachricht wird automatisch die Ankunftszeit bzw. der Treffpunkt eingefügt (bei Heimspielen 1 Stunde vor Spielstart in der Halle; bei Auswärtsspielen 30 Minuten vor Spielstart am jeweiligen Spielort).
